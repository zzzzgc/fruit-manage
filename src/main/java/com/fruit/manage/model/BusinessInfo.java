...
//                "\tand auser.id in (SELECT ur.user_id from a_user_role ur INNER JOIN a_role r on ur.role_id = r.id where r.role_key = 'sales') ");
     ...
     * 添加商户信息
     */
    public BusinessInfo addBusinessInfo(int uId, String businessName, String businessContacts, String phone, String addressProvince, String addressCity, String addressDetail, String addressShop, int shipmentsType) {
        BusinessInfo businessInfo = new BusinessInfo();
        businessInfo.setUId(uId);
        businessInfo.setBusinessName(businessName);
        businessInfo.setBusinessContacts(businessContacts);
        businessInfo.setPhone(phone);
        businessInfo.setAddressProvince(addressProvince);
        businessInfo.setAddressCity(addressCity);
        businessInfo.setAddressDetail(addressDetail);
        businessInfo.setAddressShop(addressShop);
        businessInfo.setShipmentsType(shipmentsType);
